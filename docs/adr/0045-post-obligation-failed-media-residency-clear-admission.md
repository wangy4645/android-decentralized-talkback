...
Implementation:
  ...
  Successor observation       Q1–Q7 SEALED (Q7=S2)
  ADR-0046                    ACCEPTED (Decision YES boundary) · Implementation NOT AUTHORIZED
  Next                        ADR-0046 impl auth separate; do not force FAILED_MEDIA for 2.1
