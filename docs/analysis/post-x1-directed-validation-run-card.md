...
**Date:** 2026-08-08  
**Parent:** [X1 Validation Gate](./x1-validation-gate.md) · [X1-B progression](./x1-b-admission-progression-validation.md) · [X1-B initiator-edge validation](./x1-b-initiator-edge-validation-run-card.md) · [ADR-X1](../adr/x1-control-admission-after-recovery.md) · [pre-fix run card](./post-adr0040-control-admission-validation-run-card.md)
