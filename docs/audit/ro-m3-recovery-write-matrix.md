...
**状态**：Draft（2026-07-09）— PR-A 已落地；#73 边界冻结 R20–R22 + RECOVERY_DECISION 观测（2026-07-09）  
...
- 不用 Projection 掩盖 `authority=false`
- 不堆 Recovery 功能；先拿 `RECOVERY_DECISION` + S16 证明 Write Matrix 标红项

---

## 7. 执行顺序（冻结 2026-07-09）
