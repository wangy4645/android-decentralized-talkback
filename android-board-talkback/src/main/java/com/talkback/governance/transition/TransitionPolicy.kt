...
object TransitionPolicy {
  private val rules: Map<TransitionTrigger, TransitionPolicyRule> = mapOf(
    TransitionTrigger.MEETING_END to TransitionPolicyRule(timeoutMs = 12_000L),
    TransitionTrigger.MEETING_START to TransitionPolicyRule(timeoutMs = 8_000L),
  ...
  fun rule(trigger: TransitionTrigger): TransitionPolicyRule =
    rules[trigger] ?: TransitionPolicyRule(timeoutMs = 10_000L)
