# Conference Admission Observation — stop collectors + dump
param(
...
Write-Host "Grep: JOIN_MEETING_TRACE|ADMISSION_DECISION|SESSION_CREATED|CHANNEL_SESSION_BIND|READINESS_BINDING|SESSION_TERMINATED|SESSION_REMOVE"
